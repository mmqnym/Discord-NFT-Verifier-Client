...
function App() {
  ...
  const [discordWillShowUserName, setDiscordUserName] = (0, react_1.useState)(
    "Invalid"
  );
  const [discordWillShowUserImg, setDiscordUserImgURL] = (0, react_1.useState)(
    kaiju_logo_png_1.default
  );
  ...
  const waitingToast = () =>
    react_toastify_1.toast.loading("Connecting...", {
      position: "bottom-left",
      theme: "dark",
      toastId: "waitToast",
    });
  ...
  const [verifiedStatus, setVerifiedStatus] = (0, react_1.useState)(
    "Not Verified"
  );
  (0, react_1.useEffect)(() => {
    if (userAddress !== "0x0") {
  ...
  return (0, jsx_runtime_1.jsx)(
    "div",
    Object.assign(
      { className: "Cronos-Kaiju" },
      {
        children: (0, jsx_runtime_1.jsx)(
          "div",
          Object.assign(
            { className: "Verify-Page-bg" },
            {
              children: (0, jsx_runtime_1.jsxs)(
                ...
                Object.assign(
                  {
                    className:
                      "Verify-Page-rain bg-center w-full h-[100vh] flex flex-col gap-20 justify-center items-center",
                  },
                  {
                    children: [
                      (0, jsx_runtime_1.jsx)("img", {
                        className: "inline-block",
                        src: cronos_kaiju_png_1.default,
                        alt: "title",
                      }),
                      (0, jsx_runtime_1.jsx)(
                        "div",
                        Object.assign(
                          {
                            className: `${
                              showProfileCard ? "flex" : "hidden"
                            } flex-col md:flex-row justify-center items-center z-10 bg-gray-800 rounded-lg border-4 border-double border-purple-400 ring-offset-2 ring-2 ring-purple-200/50`,
                          },
                          {
                            children: (0, jsx_runtime_1.jsxs)(
                              "div",
                              Object.assign(
                                {
                                  className:
                                    "flex flex-col md:flex-row justify-center md:justify-between items-center gap-5 md:gap-12 px-12 md:px-8 py-3 leading-normal",
                                },
                                {
                                  children: [
                                    (0, jsx_runtime_1.jsx)(
                                      ...
                                      Object.assign(
                                        {
                                          className:
                                            "rounded-lg ring-2 ring-purple-400/60 ring-offset-2",
                                        },
                                        {
                                          children: (0, jsx_runtime_1.jsx)(
                                            "img",
                                            {
                                              className:
                                                "rounded-lg w-32 h-32 md:w-40 md:h-40",
                                              src: discordWillShowUserImg,
                                              alt: "",
                                            }
                                          ),
                                        }
                                      ...
                                      children: [
                                        (0, jsx_runtime_1.jsx)(
                                          ...
                                          Object.assign(
                                            {
                                              className:
                                                "mb-3 lg:mb-6 text-center text-xl lg:text-3xl font-bold tracking-tight text-white",
                                            },
                                            {
                                              children: discordWillShowUserName,
                                            }
                                          )
                                        ),
                                        (0, jsx_runtime_1.jsx)(
                                          ...
                                          Object.assign(
                                            {
                                              className:
                                                "mb-3 text-center font-normal lg:text-2xl text-white",
                                            },
                                            {
                                              children:
                                    ...
                                    (0, jsx_runtime_1.jsx)(
                                      ...
                                      Object.assign(
                                        {
                                          className:
                                            "rounded-lg ring-2 ring-purple-400/60 ring-offset-1 ring-offset-white/80 md:self-start",
                                        },
                                        {
                                          children: (0, jsx_runtime_1.jsx)(
                                            "p",
                                            Object.assign(
                                              {
                                                className:
                                                  "px-5 py-2 md:py-1 text-center font-bold text-pink-500",
                                              },
                                              { children: verifiedStatus }
                                            )
                                          ),
                                        }
                                      )
                      ...
                      (0, jsx_runtime_1.jsx)(
                        ...
                        Object.assign(
                          {
                            onMouseEnter: () => setActiveBtn(false),
                            onMouseLeave: () => setActiveBtn(true),
                            disabled: disable,
                            onClick: connectBtnClicked,
                            id: "connectBtn",
                            className: `${
                              isActive ? "animate-pulse" : ""
                            } z-10 rounded-lg bg-gradient-to-br from-purple-600 to-blue-500 p-1 duration-75 active:translate-y-1 active:shadow-xl active:shadow-indigo-300/50`,
                          },
                          {
                            children: (0, jsx_runtime_1.jsxs)(
                              "div",
                                  ...
                                  children: [
                                    ...
                                    (0, jsx_runtime_1.jsx)(
                                      ...
                                      Object.assign(
                                        {
                                          className:
                                            "rounded-lg bg-black py-4 px-3 text-white hover:bg-transparent hover:text-black",
                                        },
                                        {
                                          children: (0, jsx_runtime_1.jsx)(
                                            "span",
