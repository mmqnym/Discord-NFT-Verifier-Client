...
export default function CryptoModal( {visible, onClose} ) {

    const [UserAddress, setUserAddr] = useState("");
    ...
    return (
        <div onClick={handleModalColse} id="crypto-modal" tabIndex="-1" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed flex justify-center items-center z-50 w-full md:inset-0 h-modal md:h-full sm:backdrop-blur">
            <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                {/*<!-- Modal content -->*/}
                <div className="relative bg-gray-700 rounded-lg shadow dark:bg-gray-700">
                    <button onClick={onClose} type="button" className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-800 hover:text-white rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="crypto-modal">
                        <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>  
                        <span className="sr-only">Close modal</span>
                    </button>
                    {/*<!-- Modal header -->*/}
                    <div className="py-4 px-6 rounded-t border-b border-gray-400 dark:border-gray-400">
                        <h2 className="text-center text-base font-semibold text-white md:text-2xl dark:text-white">
                            Connect wallet
                        </h2>
                    </div>
                    {/*<!-- Modal body -->*/}
